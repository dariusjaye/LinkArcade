...
2. Support for Anthropic AI models:
   - Integrate Anthropic's claude 3.5 sonnet.
   - Implement model-specific configurations and API calls for the provider.
...
6. API route update:
   ...
   - Ensure proper error handling and response formatting for the provider.
